...
describe VAOS::AppointmentRequestsService do
  ...
  describe '#post_request' do
    ...
    context 'with valid creation attributes from factory' do
      let(:appointment_request_params) { build(:appointment_request_form, :creation, user:).params }
    ...
    context 'creates a new community care appointment request' do
      let(:params) { build(:cc_appointment_request_form, :creation, user:).params.merge(type: 'cc') }
