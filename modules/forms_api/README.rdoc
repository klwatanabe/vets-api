...
and have this module map that payload to the associated PDF and submit it to Central Mail.

To generate files:
rails forms_api:generate\['path to PDF file'\]

Submission endpoint:
/forms_api/v1/simple_forms

== Installation
Ensure the following line is in the root project's Gemfile:

  gem 'formsapi', path: 'modules/formsapi'
